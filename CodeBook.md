...
fBodyAccJerkMag, fBodyGyroMag, fBodyGyroJerkMag. (Note the 'f' to indicate frequency domain signals). These signals were used to estimate 
variables of the feature vector for each pattern:  '-XYZ' is used to denote 3-axial signals in the X, Y and Z directions.
...
Each subject was given an identifier captured in the variable 'subjectid' and activities were captured for each subject in the variable 
'activity'. Subjects were assigned an individual identifier number between 1 and 30. Activities were labelled as follows:
1 WALKING
2 WALKING_UPSTAIRS
